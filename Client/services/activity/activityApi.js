...
function getMainPic(farmId) {
  ...
  console.log('[getMainPic] 即将发送POST请求到: http://8.133.19.244:8889/commodity/GetMainPic');
...
function getActivityDetail(activityId) {
  ...
  console.log('[getActivityDetail] 即将发送POST请求到: http://8.133.19.244:8889/commodity/GetActivityDetail');
