...
export default {
	router: {
		...
		// systemUser: 'systemUser', // 已删除
		// systemDept: 'systemDept', // 已删除
		// systemDic: 'systemDic', // 已删除
		limits: 'limits',
		...
		deviceIndex: 'Device Management',
		deviceTemperature: 'Temperature Monitoring',
		deviceHumidity: 'Humidity Monitoring',
		deviceSoilHumidity: 'Soil Humidity',
		deviceLightIntensity: 'Light Intensity',
		deviceWindSpeed: 'Wind Speed',
		deviceRainfall: 'Rainfall',
		devicePhValue: 'PH Value',
		deviceNitrogen: 'Nitrogen Content',
		devicePhosphorus: 'Phosphorus Content',
