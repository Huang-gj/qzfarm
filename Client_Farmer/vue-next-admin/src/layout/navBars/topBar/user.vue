...
import { useUserInfo, useUserInfoStore } from '/@/stores/userInfo';
...
const getUserName = () => {
	...
	if (userInfo && userInfo.phone_number && userInfo.phone_number.trim() !== '') {
...
onMounted(() => {
	if (Local.get('themeConfig')) {
		// initI18nOrSize('globalComponentSize', 'disabledSize'); // 组件大小功能已删除
		initI18nOrSize('globalI18n', 'disabledI18n');
	}
});
</script>
