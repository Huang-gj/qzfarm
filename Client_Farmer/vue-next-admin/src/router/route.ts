		...
		children: [
			...
			},
			{
				...
				children: [
					...
					{
						path: '/make/category/add',
						name: 'makeCategoryAdd',
						component: () => import('/@/views/system/menu/category-add.vue'),
						meta: {
							title: '新增类目',
							isLink: '',
							isHide: false,
			...
			},
			{
				...
				children: [
					...
					{
						path: '/params/category/add',
						name: 'paramsCategoryAdd',
						component: () => import('/@/views/system/role/category-add.vue'),
						meta: {
							title: '新增类目',
							isLink: '',
							isHide: false,
