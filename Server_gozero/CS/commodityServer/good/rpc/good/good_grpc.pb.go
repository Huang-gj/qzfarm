...
func (c *goodClient) GetGood(ctx context.Context, in *GetGoodRepReq, opts ...grpc.CallOption) (*GetGoodRepResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGoodRepResp)
	err := c.cc.Invoke(ctx, Good_GetGood_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterGoodServer(s grpc.ServiceRegistrar, srv GoodServer) {
	// If the following call pancis, it indicates UnimplementedGoodServer was
...
func _Good_GetGood_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodServer).GetGood(ctx, req.(*GetGoodRepReq))
	}
